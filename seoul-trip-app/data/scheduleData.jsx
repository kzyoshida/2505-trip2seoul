...
export const scheduleData = [
  {
    ...
    events: [
      ...
      { time: '14:15頃', title: 'ソウル駅着', description: '地下鉄4号線で明洞駅へ（約4分）', icon: <Train className="w-5 h-5" /> },
      { time: '14:30〜15:00頃', title: '明洞到着', description: '買い物や散策', icon: <ShoppingBag className="w-5 h-5" /> },
      { time: '16:00', title: 'チェックイン', description: 'Palmtree Villa Myeongdong #201', icon: <Hotel className="w-5 h-5" /> },
      { time: 'パパ達', title: '夜ご飯など買出し', description: 'チキン、キンパ、明洞餃子、果物、飲み物など', icon: <ShoppingCart className="w-5 h-5" /> },
